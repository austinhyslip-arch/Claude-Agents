...
Newest first. Every run of every mode, including runs that sent nothing.

```
## YYYY-MM-DD | <mode>
- Ramp week and daily cap:
- Kill switches: clear | tripped (<which>)
- Sourced: <n> (free <n>, paid <n>)
- Sent: <n> AM, <n> PM, <n> follow-ups
- Held: <n> (<reasons>)
- Replies: <n> (<classification>)
- Bounce rate, trailing 100:
- Attio: <records touched>
- Notes:
```
...
## 2026-09-11 | Built
- Agent created. Nothing sourced, nothing sent.
